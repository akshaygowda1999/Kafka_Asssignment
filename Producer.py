...
FILE_PATH = "/Users/Admin/Desktop/kafka_assignment/restaurant_orders.csv"
columns=['Order Number','Order Date','Item Name','Quantity','Product Price','Total products']

API_KEY = 'DFYBUVB3FKMKAWBA'
ENDPOINT_SCHEMA_URL  = 'https://psrc-8kz20.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'XulQ40e57WcK64pixNjDSfcIlE/g9HUsNO6dUQm2XfXui+IIgK1iaf8uskgD3Wa4'
BOOTSTRAP_SERVER = 'pkc-ymrq7.us-east-2.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'JFPTE747NLLXXXYR'
SCHEMA_REGISTRY_API_SECRET = 'PvReiFj4VNUr3HJEs8ZLtm2mtD+xVtUyknHeWiXJHLHtfZLH4t3V67QM0CIaRlSI'
